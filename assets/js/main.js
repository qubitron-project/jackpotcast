 ...
 /*artist slider one*/
  ...
  if(e.target.checked === true) {
    if(document.body.classList.contains('theme-dark-active')){
      ...
      localStorage.setItem('activJballeme', 'theme-light-active');
    }
      ...
      localStorage.setItem('activJballeme', 'theme-dark-active');
    }
  }
...
var activJballeme=localStorage.getItem('activJballeme');
if(activJballeme=='theme-light-active'){
  document.body.classList.add('theme-light-active');
  document.body.classList.remove('theme-dark-active');
